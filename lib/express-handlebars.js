...
ExpressHandlebars.prototype.render = function (filePath, context, options) {
	...
	return Promise.all([
		...
		var runtimeOptions = Object.assign({}, this.runtimeOptions, options.runtimeOptions);
		...
		var templateOptions = Object.assign({}, runtimeOptions, {
			data: data,
			helpers: helpers,
			partials: partials,
		});

		return this._renderTemplate(template, context, templateOptions);
	}.bind(this));
};
